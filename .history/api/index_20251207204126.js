...
app.post("/api/montages", async (req, res) => {
    ...
    try {
        ...
        const newMontage = await Montage.create({ userId, clientName: user.nomSociete, description, statut: 'En attente', dateReception: Date.now() });
...
// ✅ 6. NOUVELLE ROUTE CONTACT (Pour remplacer EmailJS)
