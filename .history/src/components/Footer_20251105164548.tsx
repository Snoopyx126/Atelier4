      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div className="text-center md:text-right">
            ...
            <span className="font-playfair text-2xl italic tracking-tight text-white">
  L’Atelier des Arts
</span>
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mb-2 text-sm sm:text-base break-all">
              <a href="mailto:Atelierdesarts.12@gmail.com" className="hover:text-accent transition-colors">
            ...
            <p className="text-xs sm:text-sm opacity-80">
              <a href="https://maps.app.goo.gl/Sgkhwev4TQ1ndDae7"></a>
