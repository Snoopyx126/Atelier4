      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link to="/espace-pro" className="hover:text-accent transition">
    Espace Pro
  </Link>
            {/* FIN NOUVEAU */}
            {/* MODIFICATION: AJOUT du bouton "Connexion / Inscription" pour mobile */}
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 animate-fade-in">
            ...
            <Link 
        to="/espace-pro" 
        onClick={() => setIsMenuOpen(false)} // 👈 Ferme le menu après le clic
        className="text-right py-2 hover:text-accent transition"
      >
        Espace Pro
      </Link>
            {/* FIN NOUVEAU */}
