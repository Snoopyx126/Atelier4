      ...
      <div className="flex-grow pt-24 pb-10 px-6 container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            {/* Accès aux Commandes */}
            <Card 
              className="shadow-lg border-l-4 border-l-blue hover:shadow-xl transition-shadow cursor-pointer" 
            ...
            {/* Accès aux Factures */}
            <Card 
              className="shadow-lg border-l-4 border-l-green hover:shadow-xl transition-shadow cursor-pointer" 
