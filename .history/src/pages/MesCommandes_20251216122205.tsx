...
// --- HELPER FUNCTIONS GLOBALES (Accessibles partout) ---
...
const renderMontageCard = (
    ...
    // PERMISSIONS :
    // Modif : Manager (Toujours) OU Client (Si En attente/Reçu)
    const canEdit = isManager || (m.statut === 'En attente' || m.statut === 'Reçu');
    // Suppr : Client SEULEMENT (Si En attente/Reçu). Manager JAMAIS.
