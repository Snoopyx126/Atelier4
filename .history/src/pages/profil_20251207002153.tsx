...
// import { Input } from "@/components/ui/input"; // ❌ Nous n'utilisons plus ce composant pour les champs modifiables
        ...
        <div className="w-full max-w-lg space-y-8">
          ...
          <Card className="shadow-lg border-gray-200">
            ...
            <CardContent className="space-y-6">
              {/* ✅ CORRECTION DÉFINITIVE : 'noValidate' désactive TOUTE validation HTML */}
              <form onSubmit={handleSubmit} className="space-y-6" noValidate> 
                ...
                {/* 2. Email - INPUT NATIF (Type text pour éviter le pattern du navigateur) */}
                <div>
                ...
                {/* 4. Mot de passe actuel - INPUT NATIF (pas required en HTML) */}
                {(formData.email !== originalEmail) && (
                  <div className="border-t pt-4">
                    ...
                    <input 
                      id="currentPassword" 
                      type="password" 
                      // required ❌ Supprimé pour éviter toute confusion HTML
                      onChange={handleChange} 
