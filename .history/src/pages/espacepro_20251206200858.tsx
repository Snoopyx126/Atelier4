  ...
  return (
    <div className="container mx-auto py-20 px-4 sm:px-6 lg:px-8 max-w-md">
      ...
      <div className="bg-white p-8 rounded-lg shadow-xl">
        ...
        {/* Section Création de Compte (CORRIGÉE) */}
        <div className="mt-8 pt-6 border-t text-center">
          <p className="mb-4">
            Vous n'avez pas encore de compte ?
          </p>
          
          {/* ✅ Utilisation du Link vers la route que nous avons créée */}
          <Link 
            to="/inscription" 
            className="text-lg font-bold text-blue-600 hover:text-blue-800 transition-colors underline" 
          >
