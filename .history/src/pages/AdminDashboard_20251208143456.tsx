                ...
                <DialogContent className="DialogContent max-w-4xl bg-white p-0 overflow-hidden flex flex-col max-h-[95vh]">
                    ...
                    <div className="overflow-y-auto p-6 bg-gray-50 flex-grow">
                        <div id="invoice-content" className="p-10 bg-white text-black border shadow-sm mx-auto max-w-[210mm] min-h-[297mm] flex flex-col justify-between"> 
                            ...
                            <div>
                                <div className="flex justify-between items-end mb-8"><div className="bg-gray-50 border border-gray-200 p-4 rounded-lg w-1/2 mr-8"><h4 className="font-bold text-sm text-gray-900 mb-2">COORDONNÉES BANCAIRES</h4><div className="text-xs text-gray-600 space-y-1"><p>Banque : <strong>L'ATELIER DES ARTS</strong></p><p>IBAN :</p><p className="font-mono text-sm font-bold text-gray-800 tracking-wider">FR76 1820 6002 0065 1045 3419 297</p><p className="text-[10px] text-gray-400 mt-1">BIC : AGRIFRPP882</p></div></div><div className="w-1/3 space-y-3"><div className="flex justify-between text-gray-600"><span className="font-medium">Total HT</span><span>{totalHT.toFixed(2)} €</span></div><div className="flex justify-between text-gray-600"><span className="font-medium">TVA (20%)</span><span>{tva.toFixed(2)} €</span></div><div className="flex justify-between text-2xl font-extrabold text-gray-900 border-t-2 border-gray-900 pt-3"><span>Net à payer</span><span>{totalTTC.toFixed(2)} €</span></div></div></div>
