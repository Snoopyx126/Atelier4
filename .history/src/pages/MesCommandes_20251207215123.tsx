...
interface Montage { _id: string; reference: string; frame: string; description: string; category: string; options: string[]; statut: string; dateReception: string; }
...
const MesCommandes = () => {
  ...
  const filteredMontages = montages.filter(m => {
    ...
    return (
        ...
        dateStr.includes(term) // ✅ Recherche par date (ex: "08/12")
    );
  });
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-grow pt-24 pb-12 px-4 max-w-5xl mx-auto w-full">
        ...
        <Card className="mb-10 shadow-md border-blue-100">
            <CardHeader><CardTitle>Nouveau dossier de montage</CardTitle><CardDescription>Remplissez les détails.</CardDescription></CardHeader>
            <CardContent>
