...
// --- DÉFINITION DES PRIX FACTURE (MISE À JOUR) ---
...
const URGENCY_RATES: Record<string, number> = { 'Urgent -3H': 0.50, 'Urgent -24H': 0.30, 'Urgent -48H': 0.20, 'Standard': 0.00 }; // Taux d'augmentation (50%, 30%, 20%)
                        ...
                        <form onSubmit={handleSaveMontage} className="space-y-4 pt-4">
                            ...
                            <div className="space-y-3 p-4 border rounded-lg bg-gray-50">
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    {/* ✅ CHANGEMENT DE FORME (PRIX RETIRÉ) */}
                                        ...
                                        <AccordionItem key={shopName} value={shopName} className="bg-white border rounded-lg shadow-sm px-4">
                                            <AccordionTrigger className="hover:no-underline py-4">
                                                <div className="flex items-center gap-4 w-full pr-4">
                                                    ...
                                                    {/* BOUTON FACTURE : désactivé uniquement s'il n'y a aucun montage TERMINÉ, sinon cliquable. */}
                                                    <Button 
                                                        ...
                                                        disabled={items.length === 0} // Désactiver si le client n'a AUCUN montage
                                                    >
