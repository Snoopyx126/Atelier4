...
const CommentCaMarche = () => {
  ...
  <div className="text-center mb-10">
    <h1 className="text-4xl font-playfair font-bold text-gray-900 mb-3 break-words"> 
      {/* Ajoutez la classe 'break-words' si le titre complet est vraiment long 
         ou réduisez la taille de la police pour les petits écrans (ex: sm:text-3xl) */}
      Comment Ça Marche ?
    </h1>
