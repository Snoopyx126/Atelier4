...
// --- COMPOSANT MODAL DE FACTURATION (inchangée) ---
...
const InvoiceModal: React.FC<InvoiceProps> = ({ client, montages, isOpen, onClose }) => {
    ...
    const handleDownloadPDF = () => {
        ...
        html2canvas(input, { scale: 2, allowTaint: true, useCORS: true }).then((canvas) => {
            ...
            // onClose(); // Ne ferme plus la modale pour laisser le choix à l'utilisateur
        }).catch(err => {
  ...
  const handleStatusChange = async (id: string, newStatus: string) => { 
      ...
      try {
          ...
          if (data.success) {
               ...
               // En cas d'échec du serveur, revenir à l'état local précédent
