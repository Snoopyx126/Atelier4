...
const AdminDashboard = () => {
  ...
  // ✅ MODIFICATION ICI : Ne pas afficher la gravure si elle est à 0
  const renderMontageDetails = (m: Montage) => ( 
      <div className="flex flex-wrap items-center gap-2">
          ...
          {/* ❌ AVANT : {m.engravingCount && m.engravingCount > 0 && <Badge className="bg-purple-100 text-purple-800">✍️ {m.engravingCount} Gravure(s)</Badge>} */}
          {/* ✅ APRÈS : Vérifie si la valeur est > 0 ET si elle n'est pas null/undefined */}
      ...
      <div className="flex-grow pt-24 pb-10 px-6 container mx-auto max-w-7xl">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <div className="flex gap-3">
                ...
                {/* ✅ BLOC DU CHANGEMENT DE FORME ET OPTIONS VERRES (CORRIGÉ) */}
