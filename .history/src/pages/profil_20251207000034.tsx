...
const Profil = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // NOTE: L'API devrait retourner les données utilisateur mises à jour
      const response = await fetch("http://localhost:3001/profil-update", {
        method: "PUT", 
        headers: {
          "Content-Type": "application/json",
          // IMPORTANT: Inclure le jeton d'authentification ici (si utilisé)
        },
          ...
          <Card className="shadow-lg border-gray-200">
            ...
            <CardContent className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-6"> 
                ...
                {/* Nom de la société - Sans pattern strict */}
                <div>
                ...
                <div>
                  ...
                  <Input 
                    ...
                    // ✅ CORRECTION : Suppression du 'pattern' qui causait l'erreur
                    maxLength={14} 
                    title="Veuillez entrer exactement 14 chiffres (le numéro SIRET)." 
                    // Ajout d'une fonction pour accepter seulement les chiffres
                    onInput={(e) => {
                        e.currentTarget.value = e.currentTarget.value.replace(/[^0-9]/g, '');
                        // On force la mise à jour de l'état après le nettoyage
