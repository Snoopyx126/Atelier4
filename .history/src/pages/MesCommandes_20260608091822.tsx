                    ...
                    <div className="p-4 bg-blue-50 border border-blue-200 rounded-xl">
                      ...
                      <Select onValueChange={setTargetClient} value={targetClient}>
                        ...
                        <SelectContent className="bg-white rounded-xl max-h-60">
                          {[...clientsList].sort((a: any, b: any) => a.nomSociete.localeCompare(b.nomSociete, 'fr', {sensitivity:'base'})).map((c: any) => <SelectItem key={c._id} value={c._id}>{c.nomSociete}</SelectItem>)}
                        </SelectContent>
                      </Select>
                    </div>
                  )}
