...
const Profil = () => {
  ...
  // ✅ Suppression de l'argument 'e: React.FormEvent'
  const handleSubmit = async () => {
    ...
    // 2. Validation JavaScript - Email (remplace le type="email" du HTML)
    ...
    // 3. Validation JavaScript - SIRET (garanti 14 chiffres)
        ...
        <div className="w-full max-w-lg space-y-8">
          ...
          <Card className="shadow-lg border-gray-200">
            ...
            <CardContent className="space-y-6">
              {/* ✅ CORRECTION DÉFINITIVE : Remplacement de <form> par <div> pour supprimer la validation native */}
