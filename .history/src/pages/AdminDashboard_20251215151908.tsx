                    ...
                    return (
                        <div key={m._id} className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 bg-gray-50 rounded-lg border border-gray-100 gap-4 transition-all hover:bg-white hover:shadow-md">
                            ...
                            <div className="flex items-center gap-3 w-full sm:w-auto mt-2 sm:mt-0">
                                ...
                                {m.photoUrl ? (
                                    <Button variant="outline" size="icon" className="text-blue-600 border-blue-200 hover:bg-blue-50" onClick={async () => {
                                        toast.loading("Chargement de la photo...", { id: 'load-photo' });
                                        try {
                                            // APPEL DE LA ROUTE UNIQUE POUR RÉCUPÉRER L'IMAGE LOURDE
                                        ...
                                        } catch (e) { toast.error("Erreur chargement", { id: 'load-photo' }); }
                                    }}>
