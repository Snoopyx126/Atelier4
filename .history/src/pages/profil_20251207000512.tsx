            ...
            <CardContent className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-6"> 
                ...
                <div>
                  ...
                  <Input 
                    id="email" 
                    // Changement du type en 'text' pour éviter tout pattern implicite
                    type="text" 
                    readOnly 
                    className="bg-gray-100 cursor-not-allowed" 
                    value={formData.email} 
                    // Ajout d'une validation HTML simple et non stricte si le champ était modifiable
                    // pattern="[^@\s]+@[^@\s]+\.[^@\s]+" 
                  />
                </div>
                
                {/* SIRET (Déjà corrigé, mais reconfirmer) */}
                <div>
                  ...
                  <Input 
                    ...
                    maxLength={14} // UNIQUEMENT maxLength
                  />
                </div>
