...
interface UserData { 
    ...
    siret: string;    // Garder le siret pour l'affichage si besoin
}
  ...
  useEffect(() => {
    ...
    if (userDataString) {
      try {
        ...
        // Simuler la récupération des champs d'adresse si non présents (à retirer si votre login les fournit)
