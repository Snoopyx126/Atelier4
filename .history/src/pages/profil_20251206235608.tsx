          ...
          <Card className="shadow-lg border-gray-200">
            ...
            <CardContent className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-6"> 
                ...
                {/* SIRET */}
                // src/pages/Profil.tsx (Partie dans le formulaire)
...
// ...
                ...
                <div>
                  ...
                  <Input 
                    ...
                    // ✅ FIX : Ajoutez ces attributs pour garantir 14 chiffres exacts
                    pattern="[0-9]{14}" 
                    maxLength={14}
                    title="Le numéro SIRET doit contenir exactement 14 chiffres." // Message d'erreur personnalisé
                  />
                </div>
// ...
