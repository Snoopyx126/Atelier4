...
import { Phone, Mail, FileText, ShoppingCart, Receipt } from "lucide-react"; // Ajout de ShoppingCart et Receipt
          ...
          <div className="md:col-span-1 space-y-6">
            ...
            <Card className="shadow-lg border-l-4 border-l-blue-500">
              ...
              <CardContent className="space-y-2">
                <div className="flex items-center text-sm text-gray-700 gap-2"><Mail className="w-4 h-4 text-blue-500" /> {user.email}</div>
                ...
                <div className="flex items-center text-sm text-gray-700 gap-2"><FileText className="w-4 h-4 text-blue-500" /> SIRET: {user.siret}</div>
                <Button onClick={handleEditProfile} className="w-full bg-blue-500 hover:bg-blue-600 text-white mt-4">
                  Modifier mon profil
                </Button>
              </CardContent>
            </Card>
