...
const CommentCaMarche = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ✅ CORRECTION : Ajout de la classe pt-20 pour forcer l'espacement sous la barre de navigation fixe */}
      <div className="container mx-auto pt-20 pb-12 px-4 sm:px-6 lg:px-8 max-w-4xl">
        
        <div className="text-center mb-10">
          {/* Correction mineure pour une meilleure gestion sur mobile (sm:text-3xl) */}
        ...
        <div className="bg-white shadow-lg rounded-xl p-6 mb-8 border-t-4 border-accent">
          ...
          <ul className="list-disc list-inside space-y-2 pl-4 text-gray-600">
            ...
            <li>
              **Montages Complexes (Percéé, Diamond cut) :** **3 à 5 jours ouvrés** après réception.
            </li>
            <li>
        ...
        <div className="bg-white shadow-lg rounded-xl p-6 mb-8 border-t-4 border-accent">
          ...
          <a 
            href="/Tarif.pdf" // 👈 Assurez-vous que ce fichier est dans votre dossier public
            target="_blank" 
        ...
        <div className="bg-white shadow-lg rounded-xl p-6 mb-8 border-t-4 border-accent">
          ...
          <a 
            href="/Fiche.pdf" // 👈 Assurez-vous que ce fichier est dans votre dossier public
            target="_blank" 
            rel="noopener noreferrer"
          >
